...
from .views import Discount, UseCoupon, CouponList, CouponDetail, CouponHistoryList, \
    AvailableCouponsForOrder, AvailableCoupons

urlpatterns = [
    path('discount/', Discount.as_view()),
    path('use_coupon/', UseCoupon.as_view()),
    path('available/', AvailableCoupons.as_view()),
    path('available_for_order/', AvailableCouponsForOrder.as_view()),
