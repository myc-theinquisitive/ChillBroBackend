    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('allowed_product_types', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='Coupons.AllowedProductTypesRule', verbose_name='Allowed product types rule')),
