# Generated by Django 2.2.8 on 2021-02-16 15:33
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('entities', models.ManyToManyField(blank=True, to='Entity.MyEntity', verbose_name='Entities')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('code', models.CharField(default=Coupons.helpers.get_random_code, max_length=10, unique=True, verbose_name='Coupon Code')),
