    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('icon_url', models.ImageField(storage=django.core.files.storage.FileSystemStorage('django.core.files.storage.FileSystemStorage'), upload_to=Entity.helpers.image_upload_to_amenities)),
            ],
        ),
        migrations.CreateModel(
            name='EntityAccount',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pan_image', models.ImageField(max_length=500, storage=django.core.files.storage.FileSystemStorage('django.core.files.storage.FileSystemStorage'), upload_to=Entity.helpers.upload_pan_image_for_entity)),
                ('registration_image', models.ImageField(max_length=500, storage=django.core.files.storage.FileSystemStorage('django.core.files.storage.FileSystemStorage'), upload_to=Entity.helpers.upload_registration_image_for_entity)),
                ('gst_image', models.ImageField(max_length=500, storage=django.core.files.storage.FileSystemStorage('django.core.files.storage.FileSystemStorage'), upload_to=Entity.helpers.upload_gst_image_for_entity)),
                ('aadhar_image', models.ImageField(max_length=500, storage=django.core.files.storage.FileSystemStorage('django.core.files.storage.FileSystemStorage'), upload_to=Entity.helpers.upload_aadhar_image_for_entity)),
            ],
        ),
        migrations.CreateModel(
            name='EntityUPI',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('image', models.ImageField(storage=django.core.files.storage.FileSystemStorage('django.core.files.storage.FileSystemStorage'), upload_to=Entity.helpers.upload_image_for_entity)),
