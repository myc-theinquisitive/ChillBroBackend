    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('booking_status', models.CharField(choices=[('YET_TO_APPROVE', 'YET_TO_APPROVE'), ('BUSINESS_CLIENT_REJECTED', 'BUSINESS_CLIENT_REJECTED'), ('PENDING', 'PENDING'), ('ONGOING', 'ONGOING'), ('CANCELLED', 'CANCELLED'), ('DONE', 'DONE')], default='YET_TO_APPROVE', max_length=30)),
