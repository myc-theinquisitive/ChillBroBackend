...
class CategoryProductPrices(models.Model):
    category_product = models.OneToOneField("CategoryProduct", on_delete=models.CASCADE)
    ...
    def __str__(self):
        return self.category_product.product_name
