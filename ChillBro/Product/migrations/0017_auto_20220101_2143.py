# Generated by Django 3.2.4 on 2022-01-01 16:13
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('Product', '0016_alter_travelpackagevehicle_travel_package'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='driver',
            name='licensed_from',
            field=models.PositiveIntegerField(help_text='Use the following format: <YYYY>', validators=[django.core.validators.MinValueValidator(1900), django.core.validators.MaxValueValidator(2022)]),
        ),
        migrations.AlterField(
