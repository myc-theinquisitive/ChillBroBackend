# Generated by Django 2.2.8 on 2021-06-02 00:35
...
import Product.Vehicle.helpers
import Product.Vehicle.models
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('icon_url', models.ImageField(max_length=300, upload_to=Product.Vehicle.helpers.upload_image_to_vehicle_characteristics)),
        ...
        migrations.CreateModel(
            name='VehicleType',
            fields=[
                ('id', models.CharField(default=Product.Vehicle.models.get_id, max_length=36, primary_key=True, serialize=False)),
                ...
                ('image', models.ImageField(max_length=300, upload_to=Product.Vehicle.helpers.upload_image_to_vehicle_type)),
                ('category', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='Product.Category', verbose_name='Category')),
