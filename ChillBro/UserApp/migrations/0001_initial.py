# Generated by Django 3.2.4 on 2021-09-10 12:40
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('backup_phone_number', models.CharField(blank=True, max_length=10, null=True, unique=True, validators=[django.core.validators.MinLengthValidator(10), UserApp.validations.validate_phone], verbose_name='backup_phone_number')),
                ('backup_email', models.CharField(blank=True, max_length=30, null=True, unique=True, validators=[ChillBro.validations.validate_email], verbose_name='backup_email')),
                ('id', models.CharField(default=uuid.uuid4, editable=False, max_length=36, primary_key=True, serialize=False)),
